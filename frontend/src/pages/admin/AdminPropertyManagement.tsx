...
const initialProperties: Property[] = [
  { id: '1', title: 'Skyline Residences Tower A', location: 'Colombo 03', price: 'LKR 45.0M', type: 'RESIDENTIAL', status: 'PENDING', owner: 'James Harrington', details: '3 Beds • 2 Baths • 1,500 sqft' },
  { id: '2', title: 'Metro Business Hub', location: 'Colombo 02', price: 'LKR 125.0M', type: 'COMMERCIAL', status: 'APPROVED', owner: 'Sarah Jenkins', details: '10 Offices • 4,500 sqft' },
  { id: '3', title: 'Greenfield Estate Land', location: 'Gampaha', price: 'LKR 12.0M', type: 'LAND', status: 'PENDING', owner: 'Priyantha Perera', details: '20 Perches Land' },
  { id: '4', title: 'Coral Bay Beach Villa Land', location: 'Galle', price: 'LKR 28.5M', type: 'LAND', status: 'APPROVED', owner: 'Nimal Perera', details: '15 Perches Beachfront' },
  { id: '5', title: 'North Park Industrial Warehouse', location: 'Ja-Ela', price: 'LKR 85.0M', type: 'COMMERCIAL', status: 'REJECTED', owner: 'Devinda Goonewardene', details: 'Industrial • 6,000 sqft' },
  { id: '6', title: 'Merchant Quarter Apartment', location: 'Kandy', price: 'LKR 16.5M', type: 'RESIDENTIAL', status: 'APPROVED', owner: 'Abdul Cader', details: '2 Beds • 2 Baths • 1,100 sqft' }
];
  ...
  return (
    <div className="h-full overflow-y-auto p-[20px] md:p-[32px] space-y-[32px] bg-[#e6e0d4]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[24px]">
        <div className="bg-white border border-[#ccb7a3]/20 rounded-[12px] p-[25px] shadow-sm flex items-center gap-[20px]">
          ...
          <div className="leading-tight">
            <h4 className="text-[24px] font-extrabold text-[#1d1d1d]">{totalCount}</h4>
            <span className="text-[12px] text-gray-500 font-bold">Total Listings</span>
          </div>
        </div>
        <div className="bg-white border border-[#ccb7a3]/20 rounded-[12px] p-[25px] shadow-sm flex items-center gap-[20px]">
          ...
          <div className="leading-tight">
            <h4 className="text-[24px] font-extrabold text-[#be5d3f]">{pendingCount}</h4>
            <span className="text-[12px] text-gray-500 font-bold">Pending Review</span>
          </div>
        </div>
        <div className="bg-white border border-[#ccb7a3]/20 rounded-[12px] p-[25px] shadow-sm flex items-center gap-[20px]">
          ...
          <div className="leading-tight">
            <h4 className="text-[24px] font-extrabold text-[#495d38]">{approvedCount}</h4>
            <span className="text-[12px] text-gray-500 font-bold">Approved</span>
          </div>
        </div>
        <div className="bg-white border border-[#ccb7a3]/20 rounded-[12px] p-[25px] shadow-sm flex items-center gap-[20px]">
          ...
          <div className="leading-tight">
            <h4 className="text-[24px] font-extrabold text-red-600">{rejectedCount}</h4>
            <span className="text-[12px] text-gray-500 font-bold">Rejected</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-[20px]">
        ...
        {/* Search & Actions */}
        <div className="flex items-center gap-[12px] self-start md:self-auto w-full md:w-auto">
        ...
        {filteredProperties.map((prop) => (
          ...
          >
            ...
            <div className="h-[200px] bg-[#ccb7a3]/30 border-b border-[#ccb7a3]/20 relative flex items-center justify-center text-[#1d1d1d]/60 font-extrabold text-[12px]">
              ...
              {/* Status Badge */}
              <div className={`absolute right-[16px] top-[16px] rounded-[9999px] px-[12px] py-[4px] text-[9px] font-bold tracking-wider ${
              ...
              <div className="flex flex-col items-center gap-[6px]">
                <svg className="size-[32px] text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="p-[20px] space-y-[16px]">
              <div className="space-y-[4px]">
                <h4 className="text-[16px] font-extrabold text-[#1d1d1d] line-clamp-1">{prop.title}</h4>
              ...
              <div className="flex items-center justify-between pt-[12px] border-t border-gray-50 text-[12px]">
                ...
                <div className="text-right">
                  ...
                  <span className="font-extrabold text-[#345b79] text-[14px]">{prop.price}</span>
                </div>
              </div>
      ...
      {showAddPropertyModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-[16px] backdrop-blur-[2px]">
          <div className="w-full max-w-[420px] rounded-[12px] bg-white p-[24px] shadow-lg border border-[#ccb7a3]/30">
            <h4 className="text-[18px] font-extrabold text-[#1d1d1d] mb-[4px]">Submit Listing</h4>
            <p className="text-[12px] text-gray-400 mb-[20px] font-semibold">Register a new property moderation request manually.</p>
            
            <form onSubmit={handleAddProperty} className="space-y-[16px]">
              <div>
                <label className="block text-[11px] font-bold text-[#6b879c] uppercase tracking-wider mb-[6px]">Property Title</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid grid-cols-2 gap-[16px]">
                <div>
                  <label className="block text-[11px] font-bold text-[#6b879c] uppercase tracking-wider mb-[6px]">Location</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[11px] font-bold text-[#6b879c] uppercase tracking-wider mb-[6px]">Price (M LKR)</label>
                  <input
                    type="number"
                    step="0.1"
                    required
              ...
              <div className="grid grid-cols-2 gap-[16px]">
                <div>
                  <label className="block text-[11px] font-bold text-[#6b879c] uppercase tracking-wider mb-[6px]">Type</label>
                  <select
                    value={newType}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-[#6b879c] uppercase tracking-wider mb-[6px]">Owner Name</label>
                  <input
                    type="text"
                    required
