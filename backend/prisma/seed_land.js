...
async function main() {
  ...
  const lands = [
    ...
    },
    {
      ...
      description: 'Spacious industrial land zone close to the outer circular highway interchange in Kaduwela. Wide 30ft heavy vehicle container road access. Perfect for factory building, warehouses, or yards.',
      price: 45000000,
